...
export const Login: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-deep-bg flex items-center justify-center p-4">
            {/* Background Glows */}
            ...
            <div className="w-full max-w-md relative">
                <div className="bg-deep-surface/80 border border-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl overflow-hidden">
                    <div className="flex justify-center mb-8">
                        <div className="w-16 h-16 bg-gradient-to-br from-accent-primary to-accent-secondary rounded-2xl flex items-center justify-center shadow-lg shadow-accent-primary/20">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-black/40 border border-white/10 rounded-xl py-3 pl-11 pr-4 text-bone-white focus:outline-none focus:border-accent-primary/50 focus:ring-1 focus:ring-accent-primary/50 transition-all placeholder:text-neutral-700"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-gradient-to-r from-accent-primary to-accent-secondary hover:from-accent-secondary hover:to-accent-primary text-black font-black py-4 rounded-xl shadow-lg shadow-accent-primary/20 transition-all flex items-center justify-center gap-2 group disabled:opacity-50 uppercase tracking-widest text-sm mt-4"
                        >
                            {loading ? (
