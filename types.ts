...
export type VisualStyle = 'auto' | 'brutalism' | 'neon' | 'clean' | 'organic' | 'pop-art' | 'luxury' | 'meme' | '3d-clay' | 'mystic-neon' | 'cinematic-thriller' | 'tech-agency' | 'cyber-glow' | 'satirical-split';
